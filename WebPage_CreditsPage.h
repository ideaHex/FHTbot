 ...
 * 
 */
const char creditsPage[] PROGMEM = R"=====(<!doctype html>
<html>
  <head>
    <title>FH@Tbot</title>
    <meta charset="utf-8">
...
const char creditsPage1[] PROGMEM = R"=====(color: white;
      font-size: 20px;
...
h1 {
  ...
  <body>
    <div>
      ...
      <h2><span>FH@Tbot Concept and Hardware Design</span></h2>
      ...
      <h3><span>freedesignfile........Graphics<br>
      Alexandra Etienne and Jerome Etienne... Virtual joystick</span></h3>
    </div>
    <br><br>
